...
public class RedisPublicKeyCredentialRequestOptionsRepository implements PublicKeyCredentialRequestOptionsRepository {
    ...
    private static final String COOKIE_NAME = "webauthn-request-session";
    private static final String REDIS_PREFIX = "webauthn:request:";
    ...
    public PublicKeyCredentialRequestOptions load(HttpServletRequest request) {
        ...
        return (PublicKeyCredentialRequestOptions) redis.opsForValue().get(REDIS_PREFIX + sessionId);
    }
