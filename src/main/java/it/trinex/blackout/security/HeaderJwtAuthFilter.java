...
public class HeaderJwtAuthFilter extends OncePerRequestFilter implements JwtAuthenticationFilter {
    ...
    protected void doFilterInternal(
        ...
        if (jwt == null) {
            log.debug("No Authorization header found for request to: {}", request.getRequestURI());
